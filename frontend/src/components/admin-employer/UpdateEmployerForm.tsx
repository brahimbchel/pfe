...
type EmployerFormData = {
  ...
  const schema = yup.object({
     matricule: yup.string(),
      ...
      situationFamille: yup.string(),
      groupeSanguin: yup.string(),
      rh: yup.string(),
      formationScolaire: yup.string(),
      formationProfessionnelle: yup.string(),
      qualificationProfessionnelle: yup.string(),
      numSecuSocial: yup.string(),
      statutEmploye: yup.string(),
      ...
      wilayaNaissance: yup.string(),
      adresse: yup.string(),
      wilaya: yup.string(), 
      sexe: yup.string(),
      nationalite: yup.string(),
      serviceNational: yup.string(),
  })
    ...
    const [initialData, setInitialData] = useState<EmployerFormData | null>(null);
      ...
      useEffect(() => {
        ...
        const onSubmit: SubmitHandler<EmployerFormData> = async (data) => {
            console.log("Updated Employer: for",id , data);
